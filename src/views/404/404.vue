...
<style scoped>
.big-container {
  background: linear-gradient(135deg, #ffee00 10%, yellow 90%);
  height: 98vh;
  overflow-y: hidden;
  overflow-x: hidden;
  display: flex;
...
.world .box .wall {
  ...
  background: linear-gradient(
    135deg,
    rgba(54, 45, 37, 0.4) 10%,
    rgba(8, 69, 131, 0.4) 90%
  );
